...
def decgetimg(func):
    ...
    **NOT** for use with class methods
    ...
    def _getimg_wrapper(img, *args, **kwargs):
        ...
        g = lambda v: _cv2.imread(_fixp(v))
...
def decgetimg8bpp(func):
    ...
    **NOT** for use with class methods
    ...
    def _getimg_wrapper(img, *args, **kwargs):
        ...
        g = lambda p: _cv2.imread(_fixp(p), _cv2.IMREAD_COLOR)  # forces 8bits per pixel (32/24 bit image)
...
def decgettruegrey(func):
    ...
    **NOT** for use with class methods
    ...
    def _getimg_wrapper(img, *args, **kwargs):
        ...
        g = lambda p: _cv2.imread(_fixp(p), _cv2.IMREAD_GRAYSCALE)  # forces 8bits per pixel (32/24 bit image)
        ...
        if isinstance(img, (list, tuple)):
            ...
            for im in img:
                if isinstance(im, str):
                    ...
                    if not _isbw(i, single_channel_only=True):  # noqa
